...
const Square = (props: any) => {
    // const collor = props.props === true ? "#ffffff" : 'current';
   
    const left = props.props.left ?? 200
    const top = props.props.top ?? 200
    ...
    return (
    <div className="Square" style ={{top: `${top}px`, left: `${left}px`, 'position': 'absolute'}}>
